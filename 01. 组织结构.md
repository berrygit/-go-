...
包主要用来组织代码，封装具体的实现，可以对外暴露特定功能，以达到代码复用

## 1.2 import导入
当需要使用其它package下的代码时，需要import对应的包，通过包名调用相应的函数或变量，如：
...
- java通过访问控制修饰符来指定可见性，`public`表明对其它类可见，`private`表明对其它类不可见
